<template>
  <div :class="[attrs.class]">
    <label
      v-if="label"
      class="font-size-5 mb-2 block text-grey-1"
    >
      {{ label }}
    </label>
    <div class="relative">
      <div :class="inputContainerStyle">
        <div class="flex flex-nowrap">
          ...
          <input
            ...
            "
          />
          <span class="mx-1 inline-block shrink-0 text-grey-1">&ndash;</span>
          <input
            ref="elMax"
            v-bind="{ ...attrs, class: '' }"
        ...
        <span
          :class="[
            ...
            'cursor-pointer text-blueGrey-2',
            'absolute right-4',
...
import { InputType, type IDateRangeInputProps } from '@/components/inputs/models';
import {
...
import InputErrorsList from '@/components/inputs/InputErrorsList.vue';

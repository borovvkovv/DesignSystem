...
<script lang="ts">
export default {
  name: 'PortalTableBaseHeaderCell',
};
</script>

<script setup lang="ts" generic="T">
import { computed, ref } from 'vue';
import AppTableCellText from '@/components/table/cells/AppTableCellText.vue';
...
import ColumnFilterSelectSwitch from '@/components/portal-table/column-controls/ColumnFilterSelectSwitch.vue';
import ColumnFilterNumberRange from '@/components/portal-table/column-controls/ColumnFilterNumberRange.vue';
import ColumnFilterSelect from '@/components/portal-table/column-controls/ColumnFilterSelect.vue';
import ColumnSort from '@/components/portal-table/column-controls/ColumnSort.vue';
import ColumnFilterDateRange from '@/components/portal-table/column-controls/ColumnFilterDateRange.vue';
import ColumnFilterMultiSelectSwitch from '@/components/portal-table/column-controls/ColumnFilterMultiSelectSwitch.vue';
...
const isControlInactive = (index: number): boolean => !columnControls.value?.at(index)?.isActive;

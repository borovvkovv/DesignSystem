...
import { calculateYearCalendar, changeYear, isYearDisabled } from '@/components/calendars/utils';
import BaseCalendar from '@/components/calendars/BaseCalendar.vue';
import type { ICalendarProps, IMonth } from '@/components/calendars/utils/models';

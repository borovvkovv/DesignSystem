...
export default defineComponent({
  name: 'CalendarYearsRange',
});
</script>

<script setup lang="ts">
import { computed, ref } from 'vue';
import { calculateYearsRangeCalendar, isDozenOfYearsDisabled } from '@/components/calendars/utils';
import { YEARS_IN_CALENDAR, type ICalendarRangeProps, type IYearRange } from '@/components/calendars/utils/models';
import BaseCalendar from '@/components/calendars/BaseCalendar.vue';
import CalendarYearCell from '@/components/calendars/CalendarYearCell.vue';

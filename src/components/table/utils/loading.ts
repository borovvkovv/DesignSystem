import type { TPaddingClassNames } from '@/types/cssClasses';
import type { TCell, TRow, TTableData, TTableModel, TTableModelRows } from '@/components/table/models';
import type { LineSkeletonProps } from '@/components/skeletons/models';
import type { TModifierText } from '@/components/modifiers';
import type { TPortalData } from '@/components/portal-table/utils/models';
import type { TPortalTableModel, TPortalTableModelRows } from '@/components/portal-table-model/utils/models';

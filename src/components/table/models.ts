import type { TAllClassNames } from '@/types/cssClasses';
import type {
  Extends,
  ModifierAbstract,
  TModifierBorder,
...
import type { TTabBase } from '@/components/tab-data/utils/models';
import type { ITextButtonProps } from '@/components/buttons/utils/models';
import type { IBaseInputProps } from '@/components/inputs/models';
import type { IBaseTagProps } from '@/components/tags/utils/models';
import type { LineSkeletonProps } from '@/components/skeletons/models';
import type { IconName } from '@/components/icons/models';
import type { VNode } from 'vue';
import type { LinksStyles } from '@/components/app-link/utils/models';

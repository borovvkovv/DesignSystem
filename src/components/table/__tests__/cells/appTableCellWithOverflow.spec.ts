...
import { mockBoundingClientRect } from '@/components/__tests__/utils';
import BaseFlexibleMenu from '@/components/flexible-menu/BaseFlexibleMenu.vue';
import { mockResizeObserver } from '@/components/__tests__/utils/mockedResizeObserver';
import AppTableCellWithOverflow from '@/components/table/cells/AppTableCellWithOverflow.vue';

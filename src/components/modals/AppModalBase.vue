        ...
        >
          ...
          >
            <div>
              ...
              >
                <div
                  class="flex h-12 w-12 items-center justify-center rounded-full bg-grey-5 lg:h-6 lg:w-6 lg:rounded-none lg:bg-transparent"
                >
                  <IconCross24 />
                </div>
              </AppLink>
...
import type { AppModalBaseProps } from './models';

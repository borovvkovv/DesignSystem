...
import { BooleanFilter, availabilityTelemetryOptions } from '@/views-portal/consumer/utils/models';
import { portalTableData, type PortalTableModel } from '@/views-design-system/utils/models';
      ...
      },
      {
        ...
        controls: [
          ...
          },
          {
            ...
            getColumnData: () => [
              {
                title: availabilityTelemetryOptions[BooleanFilter.Yes],
                value: BooleanFilter.Yes,
              },
              {
                title: availabilityTelemetryOptions[BooleanFilter.No],
                value: BooleanFilter.No,
              },
            ],
          },
        ],
